...
mod tests {
    ...
    async fn sends_headers_and_accepts_the_strict_contract() {
        ...
        let server = tokio::spawn(async move {
            ...
            assert!(request.contains("carrack-sdk-version: 0.1.0"));
            let body = r#"{"schema":"carrack.protocol-compatibility.v1","protocol_epoch":2,"minimum_sdk_version":"0.1.0","server_version":"0.1.0","enforcement":"required","upgrade_command":"upgrade carrack"}"#;
