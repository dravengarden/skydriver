//! Process-level contract tests for Skydriver CLI failures.
...
fn run(arguments: &[&str]) -> Output {
    Command::new(env!("CARGO_BIN_EXE_skydriver"))
        .args(arguments)
        .env_remove("SKYDRIVER_CONTROL_URL")
        .env_remove("SKYDRIVER_VFS_TOKEN")
        .output()
        .expect("run skydriver CLI")
}
