...
impl VfsClient {
    ...
    async fn load_catalog_from_first(
        ...
        let expected_root = skydriver_sdk_core::decode_lower_hex::<32>(&data_root)
...
mod tests {
    ...
    fn download_plan(file_id: &str, version_id: &str, lease_id: &str) -> serde_json::Value {
        json!({
            ...
            "etag": null,
            "driver_kind": skydriver_driver_contract::DriverKind::LocalFilesystemV2.as_str(),
            "driver_revision": 1,
            "config": {},
            "credential": null,
            "directory_key": null,
        ...
        let checkpoint_delivery = server
            .mock_async(|when, then| {
                ...
                then.status(200)
                    ...
                    .header("Skydriver-Catalog-SHA256", checkpoint_sha256)
                    .header("Skydriver-Catalog-Revision", "11")
                    .header("Skydriver-Catalog-Root", root_data_root.clone())
    ...
    fn wide_directory_hydration_streams_one_hundred_thousand_entries() {
        ...
        let mut expected = skydriver_sdk_core::DirectoryMerkleAccumulator::new();
